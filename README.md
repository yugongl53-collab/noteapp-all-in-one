...
前置条件是使用 API 31 或更高版本设备安装 Debug APK；Android 13 或更高版本需要在首次开始专注时确认通知权限，拒绝权限不会阻止计时，但后台阶段结束通知无法显示。进入底栏“工具箱”，在“事件池与抽奖”新增“阅读”和“写作”两个启用项目，再停用“写作”。连续点击“帮我选一个”或“再抽一次”，结果只能是“阅读”；点击“带入番茄钟”只会填写事项名称，不会覆盖计时时长。
