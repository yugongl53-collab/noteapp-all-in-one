...
> 当前状态：M4 已完成。用户可以管理灵感、学期、普通事件和课程，在课表或本周事件流中查看计划，并为普通事件和课程配置受 Android 系统权限约束的本地准点提醒；番茄钟、统计和备份仍按 M5 至 M7 推进。
...
以下是 MVP 核心能力。灵感、学期日程和日程提醒流程已经可用，其余业务页面仍按 M5 至 M7 逐步接入：
